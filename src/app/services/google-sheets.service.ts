...
export class GoogleSheetsService {
  ...
  private parseCsvToMarcas(csv: string): Record<string, Marca> {
    ...
    const baseConfig: Record<string, any> = {
      "Hill's PD": { id: 'hills-pd', desc: 'Nutrición clínica de vanguardia para tratar diversas condiciones de salud.', logo: 'assets/logos/hills-logo.png', banner: 'assets/banners/banner-hills-pd.png' },
      "Hill's SD": { id: 'hills-sd', desc: 'Nutrición basada en la biología para anticiparse a sus necesidades.', logo: 'assets/logos/hills-logo.png', banner: 'assets/banners/banner-hills-sd.png' },
      "Pro Plan": { id: 'proplan', desc: 'Nutrición de última generación respaldada por científicos.', logo: 'assets/logos/pro-plan-logo.png', banner: 'assets/banners/banner-pro-plan.png' },
      "Brit Care": { id: 'brit-care', desc: 'Fórmulas hipoalergénicas para el máximo cuidado.', logo: 'assets/logos/brit-care-logo.png', banner: 'assets/banners/banner-brit-care.png' },
      "Brit Premium": { id: 'brit-premium', desc: 'Excelente palatabilidad y digestibilidad con alta proteína.', logo: 'assets/logos/brit-premium-logo.png', banner: 'assets/banners/banner-brit-premium.png' },
      "Nutram": { id: 'nutram', desc: 'Recetas holísticas y naturales que optimizan la salud.', logo: 'assets/logos/nutram-logo.png' },
      "Monge": { id: 'monge', desc: 'La máxima calidad de la nutrición italiana.', logo: 'assets/logos/monge-logo.png', banner: 'assets/banners/banner-monge.png' },
      "Canbo": { id: 'canbo', desc: 'Nutrición súper premium diseñada para exigencias especiales.', logo: 'assets/logos/canbo-logo.png', banner: 'assets/banners/banner-canbo.png' },
      "Ricocan": { id: 'ricocan', desc: 'Alimento completo y balanceado.', logo: 'assets/logos/ricocan-logo.png', banner: 'assets/banners/banner-ricocan.png' },
      "Ricocat": { id: 'ricocat', desc: 'Alimento completo y balanceado.', logo: 'assets/logos/ricocan-logo.png' },
      "Orijen": { id: 'orijen', desc: 'Alimentación biológicamente apropiada.', logo: 'assets/logos/orijen-logo.jpg', banner: 'assets/banners/banner-orijen.png' },
      "Dr. Clauder's": { id: 'dr-clauders', desc: 'Nutrición super premium alemana.', logo: 'assets/logos/dr-clauders-logo.jpg' },
      "Brit Vet Diets": { id: 'brit-vet-diets', desc: 'Nutrición clínica avanzada.', logo: 'assets/logos/brit-vet-diets-logo.jpg', banner: 'assets/banners/banner-brit-vet-diets.png' },
